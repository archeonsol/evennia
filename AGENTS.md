...
- [Job Queue](docs/source/Components/Job-Queue.md): Redis retry transitions, permissions, and failure boundaries; [Attribute Flush Monitoring](docs/source/Components/Attribute-Flush-Monitoring.md): persistence failure classification and escalation; [Redis Bus Shutdown](docs/source/Components/Redis-Bus-Shutdown.md): bounded abort and worker ownership; [Redis Bus Recovery](docs/source/Components/Redis-Bus-Recovery.md): confirmed readiness, session authority, and client refresh; [Bus Test Lifecycle](docs/source/Components/Redis-Bus-Test-Lifecycle.md): fixture scheduling and cleanup.
